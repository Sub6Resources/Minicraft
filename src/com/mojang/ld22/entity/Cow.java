...
/* 47 */     //changed xt from 0 to 16 (difference in zombie(player) to sky wizard is 8)
			 int xt = 16;
/* 48 */     int yt = 14;
/*    */     
...
/* 67 */     int yo = this.y - 11;
/*    */     
/* 69 */     int col = com.mojang.ld22.gfx.Color.get(-1, 1, 5, 445);
...
/* 85 */     //  entity.hurt(this, 0, this.dir);
/*    */     //}
/*    */   }
/*    */   
/*    */   protected void die() {
...
/* 94 */       this.level.add(new ItemEntity(new com.mojang.ld22.item.ResourceItem(com.mojang.ld22.item.resource.Resource.beef), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
/*    */     }
/*    */     
