...
/* 21 */     int col = Color.get(500, 500, 520, 550);
/* 22 */     int transitionColor1 = Color.get(3, 500, level.dirtColor - 111, level.dirtColor);
/* 23 */     int transitionColor2 = Color.get(3, 500, level.sandColor - 110, level.sandColor);
/*    */     
/* 25 */     boolean u = !level.getTile(x, y - 1).connectsToLava;
/* 26 */     boolean d = !level.getTile(x, y + 1).connectsToLava;
/* 27 */     boolean l = !level.getTile(x - 1, y).connectsToLava;
/* 28 */     boolean r = !level.getTile(x + 1, y).connectsToLava;
/*    */     
...
/* Location:              C:\Users\Matthew\Downloads\Minicraft.jar!\com\mojang\ld22\level\tile\LavaTile.class
